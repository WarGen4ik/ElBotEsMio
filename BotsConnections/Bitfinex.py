...
class BitfinexError(Exception):
    """ Exception for handling bitfinex api errors """
    pass
...
#test
#bot = TradingV1('4h6IgofwZeayBucPfkptJR6vp6isSoJBN3J0KwERm2K', 'yG8bfNGIMP6U0ORIZyAsSAtaklrUo8sNxYYMGQGY4lZ')
#print(bot.account_fees()) #{'withdraw': {'BTC': '0.0005', 'LTC': '0.001', 'ETH': '0.01', 'ETC': '0.01', 'ZEC': '0.001',
